...
const BookCard = forwardRef(({ cardData }: { cardData: Partial<CardProps> }, ref: Ref<refType>) => {
   return (
      <div className="border rounded p-4 bg-bg" ref={ref}>
         ...
         <div className=" py-2 ">
            ...
            <p className="text-center">Book #1 in the A Song of Ice and Fire Series</p>
            <h4 className="font-normal py-1">
               name: <span className="text-secondary font-medium  ">{cardData.name}</span>
            </h4>
            <h4 className="font-normal py-1">
               Publisher: <span className="text-secondary font-medium ">{cardData.publisher}</span>
            </h4>
            <h4 className="font-normal py-1">
